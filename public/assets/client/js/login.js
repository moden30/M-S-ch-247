...
var caretPos, curEmailIndex, screenCenter, svgCoords, eyeMaxHorizD = 50, eyeMaxVertD = 40, noseMaxHorizD = 23, noseMaxVertD = 10, dFromC, eyeDistH, eyeLDistV, eyeRDistV, eyeDistR, mouthStatus = "small";
...
function onEmailInput(e) {
	...
	if(curEmailIndex > 0) {
        TweenMax.to([eyeL, eyeR], 1, {scaleX: .85, scaleY: .85, ease: Expo.easeOut, transformOrigin: "center center"});
		if(value.includes("@")) {
			mouthStatus = "large";
...
function coverEyes() {
	TweenMax.to(armL, .45, {x: -60, y: 2, rotation: 0, ease: Quad.easeOut});
	TweenMax.to(armR, .45, {x: 60, y: 2, rotation: 0, ease: Quad.easeOut});
}

function uncoverEyes() {
	TweenMax.to(armL, 1.35, {x: -1000, y: 220, ease: Quad.easeOut});
	TweenMax.to(armL, 1.35, {rotation: 105, ease: Quad.easeOut, delay: .1});
	TweenMax.to(armR, 1.35, {x:1000, y: 220, ease: Quad.easeOut});
...
TweenMax.set(armL, {x: -1000, y: 220, rotation: 105, transformOrigin: "top left"});
TweenMax.set(armR, {x: 1000, y: 220, rotation: -105, transformOrigin: "top right"});
