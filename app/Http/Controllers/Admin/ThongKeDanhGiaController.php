...
class ThongKeDanhGiaController extends Controller
{
    ...
    {   
        $danh_sach_sach = Sach::all(); // Lấy danh sách sách
        ...
        // Lấy ID sách từ request, nếu không có sách nào chọn sẽ là null
        ...
        if ($sach_id) {
            ...
            // Nếu không có sách nào được chọn, tính tổng tất cả các đánh giá
