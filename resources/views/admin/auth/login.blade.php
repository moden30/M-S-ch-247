                                    ...
                                    <div class="position-relative h-100 d-flex flex-column">
                                        <div class="mb-4">
                                            <a href="index.html" class="d-block">
                                                <img src="{{ asset('assets/admin/images/logooo.png') }}" alt="" height="55px">
                                            </a>
                                        </div>
                                        <div class="mt-auto">
                                            <div class="mb-3">
                                            ...
                                            <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                ...
                                                <div class="carousel-inner text-center text-white-50 pb-5">
                                                    <div class="carousel-item active">
                                                        <p class="fs-15 fst-italic">“Sách cũng giống như những người bạn thâm tình. Rằng sách sẽ xuất hiện trong cuộc đời khi bạn cần chúng nhất.” – Emma Thompson
                                                        </p>
                                                    </div>
                                                    <div class="carousel-item">
                                                        <p class="fs-15 fst-italic">“Sách là phép màu độc nhất và diệu kỳ trong đời thực” – Stephen King</p>
                                                    </div>
                                                    <div class="carousel-item">
                                                        <p class="fs-15 fst-italic">“Sách là món quà mà bạn có thể mở đi mở lại nhiều lần.” – Garrison Kellor</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- end carousel -->
                                        ...
                                        <form action="{{ route('login') }}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    <input type="password" class="form-control pe-5 password-input" placeholder="Nhập mật khẩu" name="password" id="password-input">
                                            ...
                                            <div class="mt-4 text-center">
                                                <div class="signin-other-title">
                                                    <h5 class="fs-13 mb-4 title">Nếu không đăng nhập được hãy liên hệ chúng tôi</h5>
                                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0">&copy;
                            <script>document.write(new Date().getFullYear())</script> MeSach247. <i class="mdi mdi-heart text-danger"></i>
                        </p>
                    </div>
                </div>
            </div>
