...
<!-- Mirrored from themesbrand.com/velzon/html/master/auth-signup-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Jul 2024 16:54:19 GMT -->
<head>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">Already have an account ? <a href="{{ route('xac-thuc.dang-nhap') }}" class="fw-semibold text-primary text-decoration-underline"> Signin </a> </p>
                    </div>
