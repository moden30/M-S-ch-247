                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-1 topbar-head-dropdown header-item">
                        <button type="button"
                            ...
                            <img id="header-lang-img" src="{{ asset('assets/admin/images/flags/us.svg') }}"
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                               data-lang="en" title="English">
                                <img src="{{ asset('assets/admin/images/flags/us.svg') }}" alt="user-image"
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language"
                               data-lang="sp" title="Spanish">
                                <img src="{{ asset('assets/admin/images/flags/spain.svg') }}" alt="user-image"
                                     class="me-2 rounded" height="18">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language"
                               data-lang="gr" title="German">
                                <img src="{{ asset('assets/admin/images/flags/germany.svg') }}" alt="user-image"
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language"
                               data-lang="it" title="Italian">
                                <img src="{{ asset('assets/admin/images/flags/italy.svg') }}" alt="user-image"
                                     class="me-2 rounded" height="18">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language"
                               data-lang="ru" title="Russian">
                                <img src="{{ asset('assets/admin/images/flags/russia.svg') }}" alt="user-image"
                                     class="me-2 rounded" height="18">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language"
                               data-lang="ch" title="Chinese">
                                <img src="{{ asset('assets/admin/images/flags/china.svg') }}" alt="user-image"
                                     class="me-2 rounded" height="18">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language"
                               data-lang="fr" title="French">
                                <img src="{{ asset('assets/admin/images/flags/french.svg') }}" alt="user-image"
                                     class="me-2 rounded" height="18">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language"
                               data-lang="ar" title="Arabic">
                                <img src="{{ asset('assets/admin/images/flags/ae.svg') }}" alt="user-image"
                                     class="me-2 rounded" height="18">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="quanlythanhvien">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('roles.index') }}" class="nav-link" data-key="t-crm">Quản lý Vai
                                        trò</a>
                                </li>
                                {{--                                    <li class="nav-item">--}}
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="quanlybaiviet">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('bai-viet.create') }}" class="nav-link" data-key="t-crm"> Thêm mới
                                        bài viết</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('chuyen-muc.index') }}" class="nav-link" data-key="t-crm">Quản lý
                                        chuyên mục</a>
                                </li>
                            </ul>
                        </div>
