...
@section('content')
    <div class="row">
        <div class="card-header">
            <div class="d-flex">
                <div class="flex-grow-1">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="fs-16">Sửa bài viết: {{ $baiViet->tieu_de }}</h5>
        ...
        <div class="card-body">
            <form id="createproduct-form" autocomplete="off" class="needs-validation" action="{{ route('bai-viet.update', $baiViet->id) }}" method="post" enctype="multipart/form-data" novalidate>
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tieu_de') is-invalid @enderror" id="product-title-input" value="{{ old('tieu_de', $baiViet->tieu_de) }}" name="tieu_de" placeholder="Nhập tiêu đề sách" required>
                                </div>
                                <div>
                                    <label>Nội dung chính</label>
                                    <textarea id="ckeditor-classic" name="noi_dung" class="@error('noi_dung') is-invalid @enderror">{{ old('noi_dung', $baiViet->noi_dung) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- end card -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center mb-3">
                                    <img id="anh_dai_dien" src="{{ Storage::url($baiViet->hinh_anh) }}" style="height: 200px; width: auto;">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="chuyen_muc_id" id="" class="form-select @error('chuyen_muc_id') is-invalid @enderror">
                                        @foreach($chuyenMucs as $value)
                                            <option class="" value="{{$value->id}}" @if (old('chuyen_muc_id') == $value->id) selected @endif  {{ $baiViet->chuyen_muc_id == $value->id ? 'selected' : '' }}>{{ $value->ten_chuyen_muc }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
