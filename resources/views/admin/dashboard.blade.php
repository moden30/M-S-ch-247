...
@section('content')
    <div class="row">
                                    ...
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown"
                                           aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <span class="text-muted">Theo ngày<i class="mdi mdi-chevron-down ms-1"></i></span>
                                        </a>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <!-- Dynamic sorting options can be added here -->
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end card header -->
                            ...
                            <div class="card-header align-items-center d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <!-- Additional sorting options can be placed here -->
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end card header -->
                                            ...
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img
                                                                src="{{ asset('assets/admin/images/user/avatar-3.jpg') }}"
        ...
        <style>
            ...
            .gridjs-tr {
                height: 70px; /* Có thể điều chỉnh giá trị này phù hợp với nhu cầu của bạn */
            }

            .gridjs-table {
                font-size: 100%; /* Giảm cỡ chữ xuống một nửa */
...
#table-gridjs2 .gridjs-td img {
    display: block;
    margin: 0 auto;
    max-width: 30px; /* Ensures the image fits within the column width */
    height: auto;
}
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                formatter: (cell, row) => gridjs.html(
                                    `<span style="font-size: 1.1em;">${truncateText(cell, 17)}</span><br><small style="color: gray; font-size: 0.8em;">Tên sách</small>` // Text truncated and annotated similar to 'Tác giả'
                                )
                            }
...

                            {
                                ...
                                formatter: (cell, row) => gridjs.html(
                                    `<span style=" font-size: 1.1em;">${cell}</span><br><small style="color: gray; font-size: 0.8em;">Thể loại</small>`
                                )
                            },
                            {
                                name: "Yêu thích",
                                ...
                                formatter: (cell, row) => gridjs.html(
                                    `<span style=" font-size: 1.1em;">${cell}</span><br><small style="color: gray; font-size: 0.8em;">Yêu thích</small>`
                                )
                            }
                        ],
