            ...
            <div class="card-body">
                <form action="">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="" value="{{ $binhLuan->user_id }}"
                                readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="" value="{{ $binhLuan->bai_viet_id }}"
                                readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id=""
                                value="{{ $binhLuan->ngay_binh_luan }}" readonly>
                        </div>
                    </div>
