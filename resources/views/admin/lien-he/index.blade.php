                                ...
                                <tr>
                                    ...
                                    <td class="name">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0"><img src="{{ asset('assets/admin/images/users/avatar-10.jpg') }}" alt="" class="avatar-xs rounded-circle"></div>
                                                    ...
                                                    <div class="position-relative d-inline-block">
                                                        ...
                                                        <div class="avatar-lg p-1">
                                                            <div class="avatar-title bg-light rounded-circle">
                                                                <img src="{{ asset('assets/admin/images/users/user-dummy-img.jpg') }}" id="customer-img" class="avatar-md rounded-circle object-fit-cover" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
