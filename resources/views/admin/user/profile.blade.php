                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img src="{{ Storage::url($user->hinh_anh) }}"
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('users.showProfile', $user->id) }}" class="badge bg-light text-primary fs-12">
                                <i class="ri-edit-box-line align-bottom me-1"></i> Sửa
                            </a>
                        </div>
                    </div>
                    <div class="progress animated-progress custom-progress progress-label">
                        <div class="progress-bar bg-danger" role="progressbar" style="width: {{ $completion }}%;" aria-valuenow="{{ $completion }}"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                            ...
                            <form action="{{ route('users.updateProfile', $user->id) }}" method="post"
                                ...
                                @csrf
                                @method('PUT')
                                <input type="file" name="hinh_anh" id="hidden-profile-img-file-input" style="display: none;">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
