<footer>
    ...
    <div id="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <h4 class="first-child"><i class="fa fa-info-circle" aria-hidden="true"></i> Giới Thiệu</h4>
                        <div class="ff-text"> Đọc truyện online, truyện chữ, <a
                                href="tim-kiem/index324d.html?title=&amp;author=yes&amp;keyword=yes&amp;he_liet=yes&amp;status=hoan_thanh&amp;time=update">truyen
                                full</a>, <a href="rank/index.html">truyện hay</a> được đóng góp hoàn toàn bởi các
                            thành viên: dịch giả, tác giả, editor.. tâm huyết. Web truyen luôn cập nhật những bộ <a
                                href="tim-kiem/indexe41d.html?title=&amp;author=yes&amp;keyword=yes&amp;he_liet=yes&amp;status=all&amp;time=new">truyện
                                mới</a> thuộc các thể loại đặc sắc như <a href="keyword/ngon-tinh/index.html">ngôn
                                tình</a>, tình cảm, <a href="keyword/dam-my/index.html">đam mỹ</a>, <a
                                href="keyword/bach-hop/index.html">bách hợp</a> một cách nhanh nhất.
                        </div>
                    </div>
                        ...
                        <div class="ff-text mr-1">
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <p><a href="rank/index.html"><i class="fa fa-free-code-camp"
                                                                    aria-hidden="true"></i> Bảng Xếp Hạng</a></p>
                                </div>
                                <div class="col-xs-6">
                                    <p><a href="user/dang-truyen/index.html#h1"><i class="fa fa fa-cloud-upload"
                                                                                   aria-hidden="true"></i> Đăng
                                            Truyện</a></p>
                                    <p><a href="user/deposit/index.html#h1 "><i class="fa fa fa-money"
                                ...
                                <div class="col-xs-6">
                                    <p><a href="https://play.google.com/store/apps/details?id=com.vnvnads.truyenhd"
                                          title="Google Play" target="_blank" rel="nofollow"><img
                                                ...
                                                src="{{asset('assets/client/themes/truyenfull/echo/img/brand/googleplay4.png')}}"
                                                alt="google play"></a></p>
                                </div>
                                <div class="col-xs-6">
                                    <p><a href="https://apps.apple.com/us/app/truyenhd/id6476816882"
                                          title="App Store" target="_blank" rel="nofollow"><img
                                                class="google-play" width="100"
                                                src="{{asset('assets/client/themes/truyenfull/echo/img/brand/appstore.svg')}}"
                                                alt="App Store"></a></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <p><a href="guide/index.html"><i class="fa fa-blind" aria-hidden="true"></i>
                                            Hướng Dẫn</a></p>
                                    <p><a href="q-a/index.html"><i class="fa fa-question-circle"
                                                                   aria-hidden="true"></i> Câu hỏi thường gặp</a></p>
                    ...
                    <div class="commitment ff-text mb-2 mt-1 col-xs-12">
                        <div class> Tất cả người dùng được yêu cầu tuân thủ nghiêm ngặt luật pháp và quy định quốc
                            gia có liên quan khi xuất bản nội dung. Chúng tôi từ chối mọi nội dung không hợp thuần
                            thong mỹ tục, bạo lực, bất hợp pháp khác và sẽ huỷ chúng ngay khi phát hiện.
                        </div>
                        <div class="mt-2"> Bản quyền của các tác phẩm trên trang này (tiểu thuyết, bình luận, hình
                            ảnh v.v.) thuộc về tác giả gốc. Trang này chỉ cung cấp chức năng tải lên, lưu trữ và
                            hiển thị.
                        </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="pull-left"> 2024 <i class="fa fa-copyright" aria-hidden="true"></i> truyenhdt.com<span
                        class="hidden-sm"> All right services</span> <a
                        href="http://www.dmca.com/Protection/Status.aspx?ID=4345abb2-9317-4b83-9230-fda278f9175f"
                        title="DMCA.com Protection Status" class="dmca-badge"> <img
                            src="../images.dmca.com/Badges/dmca-badge-w100-5x1-081971.png?ID=4345abb2-9317-4b83-9230-fda278f9175f"
                    ...
                    <ul>
                        ...
                        <li><a class="icon-social" rel="nofollow" target="_blank" title="Youtube"
                               href="https://www.youtube.com/@truyenhd"><i class="fa fa-youtube fa-2x"
                                ...
                                class="icon-social" rel="nofollow"
                                target="_blank" title="Telegram" href="https://t.me/TruyenHD"><i
                                    class="fa fa-telegram fa-2x" aria-hidden="true"></i></a> <a class="icon-social"
                                                                                                ...
                                                                                                href="https://fb.com/TruyenHD.net/"><i
    ...
    <script data-cfasync="false"
            src="{{asset('assets/client/themes/truyenfull/echo/js/email-decode.min.js')}}"></script>
...
<script>(function () {
        function c() {
            ...
            if (b) {
                ...
                d.innerHTML = "window.__CF$cv$params={r:'8d1788a9bda424c7',t:'MTcyODc0MDc2My4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='cdn-cgi/challenge-platform/h/b/scripts/jsd/62ec4f065604/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";
