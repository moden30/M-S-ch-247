...
@section('content')
    ...
    <div id="feedbackForm" class="feedback-form">
        ...
        <form action="/submitFeedback" method="POST">
            ...
            <input type="email" id="email" name="email" class="editable" value="sonnqph33526@fpt.edu.vn"
                required>

            <label for="link">Liên Kết:</label>
            <input type="url" id="link" name="link" class="editable"
                value="https://www.vietnovel.com/" required>
