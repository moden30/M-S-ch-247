                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion"
                                    href="#collapse1" class="collapsed" aria-expanded="false"> <span
                                        class="number">1</span><i class="fa fa-money" aria-hidden="true"></i> Vàng
                                    dùng để làm gì? </a> </h4>
                        </div>
                        <div id="collapse1" class="panel-collapse collapse" aria-expanded="false"
                            style="height: 211px;">
                            <div class="panel-body"> Dùng để mua chương VIP, bố cáo truyện, donate cho thành viên
                    ...
                    <div class="panel panel-default" id="q2">
                        ...
                        <div id="collapse2" class="panel-collapse collapse" aria-expanded="false"
                            ...
                            <div class="panel-body"> - Cách đơn giản nhất là <a
                                    ...
                                    href="../guide/referral/index.html">Giới thiệu thành viên</a><br>- Được donate
                                từ thành viên khác<br>- Khó hơn là làm <a
                                    href="../user/nhiem-vu/index.html#h1">Nhiệm Vụ</a><br>- Đăng truyện và set
                                chương VIP. Nếu có độc giả mua bạn sẽ được Vàng.<br>- Quy đổi từ lượt xem của truyện
                                sang Vàng </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion"
                                    href="#collapse4" class="collapsed" aria-expanded="false"> <span
                                        class="number">4</span>Tôi nạp Vàng sau bao lâu sẽ nhận được? </a> </h4>
                        </div>
                        <div id="collapse4" class="panel-collapse collapse" aria-expanded="false"
                            style="height: 211px;">
                            <div class="panel-body"> - Đối với Paypal bạn sẽ nhận được ngay<br>- Đối với thẻ cào sẽ
                        ...
                        <div id="collapse16" class="panel-collapse collapse" aria-expanded="false"
                            ...
                            <div class="panel-body"> Hệ thống lưu lịch sử đọc truyện vào trình duyệt chứ không lưu
                                vào tài khoản. Hãy dùng chức năng <a
                                    href="../user/setting/data/index.html#h1">chuyển đổi từ liệu</a> để chuyển đổi 2
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="panel panel-default" id="q3">
                        ...
                        <div id="collapsez3" class="panel-collapse collapse" aria-expanded="false"
                            style="height: 211px;">
                            <div class="panel-body"> Lên đến 90%. Nghĩa là nếu truyện của bạn bán được 100 Vàng thì
