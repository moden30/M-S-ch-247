    ...
    <style>
        * {
        ...
        @media (min-width: 992px) {
            ...
            .col-btn-home-icon:nth-child(4),
            .col-btn-home-icon:nth-child(5),
            .col-btn-home-icon:nth-child(6) {
                display: none;
            }
        }
        ...
        .lb-item {
            ...
            left: 0;
            color: #fff;
            background-image: linear-gradient(135deg, #c9ad22 30%, #df9d39 100%);
            text-align: center;
            margin-left: -8px;
            padding: 2px 10px;
            top: 5px;
        ...
        .lb-item:after {
            ...
            border-style: solid;
            border-width: 0 8px 8px 0;
            border-color: transparent #df9d39 transparent transparent;
            position: absolute;
            top: 100%;
            left: 0;
            z-index: 1
        ...
        @media (min-width: 992px) {
            ...
            /* .slider-item img { border: 1px solid #df9d39; }*/
            .lb-item:after {
